...
images:
  [
    '/static/images/5-online-resume-building-tools-to-help-you-create-a-professional-resume/rxresume.webp',
  ]
...
<ImageCard link="https://rxresu.me/">
  <Image
    className="rounded-lg"
    src="/static/images/5-online-resume-building-tools-to-help-you-create-a-professional-resume/rxresume.webp"
    alt="Reactive Resume"
    width={700}
    height={284}
  />
...
<ImageCard link="https://www.rezi.ai/ai-resume-builder">
  <Image
    className="rounded-lg"
    src="/static/images/5-online-resume-building-tools-to-help-you-create-a-professional-resume/rezi.webp"
    alt="rezi"
    width={700}
    height={284}
  />
...
<ImageCard link="https://resumake.io/">
  <Image
    className="rounded-lg"
    src="/static/images/5-online-resume-building-tools-to-help-you-create-a-professional-resume/resumake.webp"
    alt="Resumake"
    width={700}
    height={284}
  />
...
<ImageCard link="https://www.resume.com/">
  <Image
    className="rounded-lg"
    src="/static/images/5-online-resume-building-tools-to-help-you-create-a-professional-resume/resumecom.webp"
    alt="Resume.com"
    width={700}
    height={284}
  />
...
<ImageCard link="https://flowcv.com/">
  <Image
    className="rounded-lg"
    src="/static/images/5-online-resume-building-tools-to-help-you-create-a-professional-resume/flowcv.webp"
    alt="Flow CV"
    width={700}
    height={284}
  />

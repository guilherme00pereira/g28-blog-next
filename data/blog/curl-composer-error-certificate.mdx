...
draft: false
summary: "Composer Error with Curl - Certificate Problem"
---


Error when using composer to install a package, generating the error message “curl 60: unable to get local issuer”. This is related to a problem with the certificate, as we will see in this article.

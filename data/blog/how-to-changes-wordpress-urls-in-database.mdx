...
```
<Alert type>
It is important to note that you should not change URLs directly in the database unless you are confident in what you are doing. Alternatively, you can use a plugin such as "Better Search Replace" to update your URLs automatically
</Alert>

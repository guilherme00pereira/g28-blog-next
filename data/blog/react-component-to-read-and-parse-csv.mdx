...
tags: ['react']
draft: false
banner: "react-component-to-read-and-parse-csv/react-parse-csv-01.webp"
...
<ImageCard>
    <Image className="rounded-lg" src="/static/images/react-component-to-read-and-parse-csv/react-parse-csv-01.webp" alt="React Parse CSV Screen" width={700} height={284} />
</ImageCard>

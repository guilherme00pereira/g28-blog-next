    ...
    return (
        <div className='w-full'>
            <StackSection title="Languages">
                ...
                <Brand title="Javascript" url="https://developer.mozilla.org/en-US/docs/Web/JavaScript" progress="90">
            ...
            <StackSection title="Tools">
                ...
                <Brand>
                    <SiJirasoftware color='default' size={64} />
                </Brand>
            </StackSection>
            ...
            <StackSection title="IDE's">
                <Brand>
                    <SiWebstorm color='#0BDCE2' size={64} />
                </Brand>
                <Brand>
